					...
					<tr class="contentbox">
						<td class="content">
							...
							<table border="0" cellspacing="0" cellpadding="10">
								<form action="review2" method="post" name="board_frm">
									<tr>
									...
									<tr>
										...
										<input class="button_type01" type="button" value="삭제" onclick="script:window.location='reviewDelete?rnum='">
										<input class="button_type01" type="button" value="글목록" onclick="script:window.location='review'">
									</tr>
								</form>							
							</table>
							</center>							
