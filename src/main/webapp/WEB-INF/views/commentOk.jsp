      ...
      <div class="container">
         <form role="review--form" action="" method="post" >
            ...
            <div class="form-group">
               ...
               <input type="text" name="mid" class="form-control" id="mid" value="${memberId}" readonly>
            </div>
            ...
            <div class="form-group">
               ...
               <textarea class="form-control summernote" name="content" id="content" value="${content} "></textarea>
